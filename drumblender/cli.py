...
def run_cli():
    """ """
    # ### HIGHLIGHT: Allow repeated runs in the same workspace directory by
    # overwriting the transient config.yaml generated by LightningCLI.
    _ = LightningCLI(
        save_config_callback=SaveConfigCallbackWanb,
